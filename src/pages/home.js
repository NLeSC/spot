...
module.exports = PageView.extend({
  initialize: function () {
    ...
    introWelcome.oncomplete(function () {
      localStorage.setItem('doneWelcome', 'welcomed');
    });
    ...
    var doneWelcome = localStorage.getItem('doneWelcome') === 'welcomed';
    if (doneWelcome) {
  ...
  demoSession: function () {
    ...
    var session_url = 'https://raw.githubusercontent.com/fdiblen/spot-data/87ed77fc3f3585e7b8d4c164ffe7aae486761962/demo_session.json';
